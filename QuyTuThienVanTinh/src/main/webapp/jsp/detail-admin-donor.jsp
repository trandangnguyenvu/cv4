...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>    
<%-- trang này không cần file body, là bảng chi tiết cho trang body-admin-donnor.jsp, liệt kê các lượt QG đã được xác nhận của một đợt QG --%>
...
<div id="layoutSidenav_content"> <!-- CLOSE TAG OF THIS DIV TAG IS AT FOOTER.JSP -->
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Chi tiết của đợt QG:</h1> <%-- iddonationround --%>                    
                   	<c:forEach var="donation" items="${list }">
                   		<c:if test="${iddonationround.equals(Integer.toString(donation.getId())) }"> <%-- Note! thuộc tính 'id' của list (class DonationRound) là int, không phải String --%>                 			
                   			<h3>'${donation.getTitle() }'</h3>
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="/QuyTuThienVanTinh/Controller?action=${action }">Back</a></li>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td style="text-align: right;">
                                    	...
                                    	float moneyTotal = 0;
                                    	for (DonorDetail d: ddList) { 
                                    		if (d.getdID().equals(session.getAttribute("iddonationround")) && d.getStatus().equals("Confirmed")) {
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;">
                                    	...
                                    	int countTotal = 0;
                                    	for (DonorDetail d: ddList) {
                                    		if (d.getdID().equals(session.getAttribute("iddonationround")) && d.getMoney() > 0) {
                                    			countTotal++;
                                    		}
                                    	}
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;">
                                    	...
                                    	for (DonorDetail d: ddList) {
                                    		if (d.getdID().equals(session.getAttribute("iddonationround")) && d.getMoney() > 0 && d.getStatus().equals("Confirmed")) {
                                    			countTotalConfir++;
                                    		}
                                    	}
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;">
                                    	...
                                    	for (DonorDetail d: ddList) {
                                    		if (d.getdID().equals(session.getAttribute("iddonationround")) && d.getMoney() > 0 && d.getStatus().equals("Pending")) {
                                    			countTotalPending++;
                                    		}
                                    	}
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;">
                                    	...
                                    	for (DonorDetail d: ddList) {
                                    		if (d.getdID().equals(session.getAttribute("iddonationround")) && d.getMoney() > 0 && d.getStatus().equals("Rejected")) {
                                    			countTotalReject++;
                                    		}
                                    	}
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
								...
								<c:forEach var="donor" items="${ddListWithSort }"><%-- donation round ID unduplicated list --%>	
									...
									<c:if test="${iddonationround.equals(donor.getdID()) }">
										<tr>
											<%-- STT --%>
											<td>
												<%
											...
											<td style="text-align: center;">
												<c:if test="${donor.getStatus() == 'Pending' }">
													...
													<%-- info for mail sending --%>
													<c:set scope="session" var="iddonor" value="${donor.getiD() }"></c:set>													
												</c:if>
											</td>
